...
## Algorithm
1.Load the weather dataset, select input features (hum, pressure, wind_speed, illumination, co2), and handle missing values using mean imputation.
2.Split the dataset into training and testing sets for each target variable: PM2.5 pollution, temperature, and TSR energy.
3.Train a DecisionTreeRegressor model with max_depth=5 using the training data and predict outputs for the test data.
4.Evaluate model performance using RMSE and R² Score, then display the prediction accuracy for pollution, temperature, and energy.
...
## Output:
<img width="800" height="332" alt="image" src="https://github.com/user-attachments/assets/c9c72a59-ae2c-4c20-b5ac-f3dbbf68dd19" />
